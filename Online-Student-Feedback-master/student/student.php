...
<!DOCTYPE html>
	...
	<body>
		...
		<center>
		<div class="a">
		<button type="submit" class="btn btn-info"><a href="addstudent.php" style="text-decoration: none">Add Student</a></button>
		<button type="submit" class="btn btn-info"><a href="addsub.php" style="text-decoration: none">Add Subject</a></button>
		<button type="submit" class="btn btn-info"><a href="delfed.php" style="text-decoration: none">Delete Feedback</a></button>
		<button type="submit" class="btn btn-info"><a href="admin.php" style="text-decoration: none">Admin</a></button>
		<button type="submit" class="btn btn-info"><a href="delstudent.php" style="text-decoration: none">Delete Student</a></button>
		<button type="submit" class="btn btn-info"><a href="feedback.php" style="text-decoration: none">Feedback</a></button>
		<button type="submit" class="btn btn-info"><a href="fullfec.php" style="text-decoration: none">Full Feedback</a></button>
		</div>
		</center>
